const AboutPics = [
    ...
    {
        name: 'Development',
        caption: "I've had the privilege to be able to learn and practice coding on my own terms (with the help of tons of great teachers and resources!). All of the portfolio projects on this site have been completed from scratch. My projects, along with this site itself, are constantly being improved. Enjoy my site!"
    },
]
